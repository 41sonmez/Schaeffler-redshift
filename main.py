...
MATERIALDATA_FILE = os.path.join(BASE_PATH, '043_stocks_500.csv') 
...
# REDSHIFT PARAMETERS
HOST = "datalake-redshift-cluster-prod.cwqkshh0kky2.eu-central-1.redshift.amazonaws.com"
PORT = 5439
DATABASE = "users"
USER = "uib99448"
PASSWORD = "MEsLMVqUcBdqHi7AT4bA" 
SCHEMA = "schema_f540_fst_ohd_camera_results" 

# GLOBAL REDSHIFT TABLO İSİMLERİ (FULL NAME)
TARGET_TABLE_NAME = f"{SCHEMA}.material_processes_count_test" 
TEMP_TABLE_NAME = f"{SCHEMA}.material_processes_count_temp"

# ******************************************************************************
# --- HELPER FUNCTIONS (MODIFIED FOR MEMORY EFFICIENCY) ---
# ******************************************************************************
